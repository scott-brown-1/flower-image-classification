...
TRAIN_PATH = './data/training_aug/'
TEST_PATH = './data/testing/'
LABELS_PATH = './data/aug_labels.csv'
...
#val_labels['ID'] = val_labels['ID'].apply(lambda x: os.path.join(val_images_dir, x))
...
test_eval = cnn.evaluate(val_gen)
...
## Write out y_pred
y_pred_df = pd.DataFrame({'ID': pred_files, 'Prediction': y_pred})
